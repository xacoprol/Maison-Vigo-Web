...
La contratación implica la aceptación íntegra de estas condiciones, de la Política de Privacidad y de la Política de Cookies.
...
El proceso de compra incluye, a título general:

1. Selección de productos en la tienda online
2. Revisión del carrito
3. Identificación o acceso a cuenta de cliente
4. Indicación de dirección de entrega y facturación
...
Los precios se muestran en euros (€) e **incluyen el Impuesto sobre el Valor Añadido (IVA)** u otros impuestos aplicables, salvo indicación expresa en contrario.
...
Se aceptan, según disponibilidad en el proceso de compra:
...
### 8.1. Transportista y ámbito

Los envíos se realizan a través de **CTT Express** u otro operador logístico equivalente, exclusivamente dentro de **España**, salvo ampliación expresa comunicada en la web.
...
El riesgo de pérdida o daño de los productos se transmite al cliente en el momento de la entrega material en la dirección indicada. El cliente debe revisar el estado del paquete en el acto de recepción y comunicar incidencias visibles en un plazo máximo de **48 horas** a [[EMAIL:care|maisonvigo.es]].

## 9. Derecho de desistimiento (productos estándar)

### 9.1. Plazo y ejercicio

Conforme a los artículos 102 y siguientes del Real Decreto Legislativo 1/2007 (TRLGDCU), el consumidor y usuario tiene derecho a desistir del contrato de compra de **productos estándar no personalizados** en un plazo de **14 días naturales** sin necesidad de justificación, desde la entrega del bien o la celebración del contrato, según corresponda.

Para ejercer el desistimiento, notifique su decisión de forma inequívoca a [[EMAIL:care|maisonvigo.es]] o por correo postal a la dirección del domicilio social, indicando número de pedido y producto.
...
De conformidad con el **artículo 103.l) del TRLGDCU**, **no existe derecho de desistimiento** en los contratos de suministro de bienes confeccionados conforme a las especificaciones del consumidor o claramente personalizados.

Se consideran **productos personalizados**, entre otros:

- Productos elaborados o adaptados a medida de un perro concreto
- Combinaciones o rutinas de cuidado personalizadas no susceptibles de reventa estándar
- Artículos grabados, bordados o fabricados según indicaciones específicas del cliente
- Productos mixtos o packs creados expresamente por encargo
- Cualquier artículo identificado en la ficha o en el proceso de compra como **«personalizado»**, **«bajo pedido»** o **«no sujeto a desistimiento»**

Antes de confirmar la compra de un producto personalizado, el cliente será informado de forma clara y destacada de la exclusión del derecho de desistimiento y deberá confirmar expresamente su conocimiento cuando el sistema de compra lo requiera.

## 11. Cambios, devoluciones por defecto o error

Independientemente del desistimiento, si el producto resultara defectuoso, no conforme con el contrato o entregado por error, el cliente podrá ejercer los derechos de conformidad previstos en el TRLGDCU (reparación, sustitución, rebaja del precio o resolución), contactando en [[EMAIL:care|maisonvigo.es]] en un plazo razonable desde la detección.
...
Para consultas, incidencias o reclamaciones:
...
Estas condiciones se rigen por la **legislación española**, en particular el TRLGDCU y normativa de comercio electrónico.

Para controversias con consumidores, serán competentes los tribunales del domicilio del consumidor o de Vigo, según resulte imperativo conforme a la normativa de consumo.
