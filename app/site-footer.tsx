...
import {
  useTiendaLegal,
  type TiendaLegalDocKey,
} from "./tienda-legal-provider";

function isCheckoutPath(pathname: string) {
  return (
    pathname === "/tienda/checkout" || pathname.startsWith("/tienda/checkout/")
  );
}
...
function FooterLegalLink({
  ...
  href: string;
  label: string;
  legalKey?: TiendaLegalDocKey;
  asSheet: boolean;
}) {
  const legal = useTiendaLegal();

  if (asSheet && legalKey && legal) {
    return (
      <button
        type="button"
        className="footer-legal-link"
        onClick={() => legal.openLegal(legalKey)}
      >
        {label}
      </button>
    );
  ...
  return (
    <a className="footer-legal-link" href={href}>
      {label}
    </a>
  );
}
...
export function SiteFooter() {
  ...
  return (
    <footer
      className={"site-footer" + (checkout ? " site-footer--checkout" : "")}
    >
      {!checkout ? (
        <section id="contacto" className="site-footer__contacto">
          ...
          <div className="contact-block contact-block--align-center-r">
          ...
          <div className="contact-block contact-block--align-center-l">
          ...
          <div className="contact-block contact-block--align-end">
